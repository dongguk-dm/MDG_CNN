...
class BaseOptions():
	...
	def initialize(self):
		self.parser.add_argument('--dataroot', type=str, default="train_no_flipping/", help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
		self.parser.add_argument('--batchSize', type=int, default=4, help='input batch size')

		self.parser.add_argument('--loadSizeX', type=int, default=256, help='scale images to this size')
		self.parser.add_argument('--loadSizeY', type=int, default=256, help='scale images to this size')
		...
		self.parser.add_argument('--learn_residual', default=True, action='store_true', help='if specified, model would learn only the residual to the input')
